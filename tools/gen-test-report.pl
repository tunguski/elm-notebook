...
<title>elm-notebook \x{b7} test report</title>
<style>
...
<div class="wrap">
  <div class="head">
    <h1>elm-notebook test report</h1>
    <div class="summary">
    ...
    <div><a class="back" href="index.html">&larr; back to the notebook</a></div>
  </div>
  $sections
  <div class="foot">Generated from the elm-test JSON report \x{b7} the kernel is pure, so every check runs headlessly.</div>
</div>
</body>
</html>
HTML
